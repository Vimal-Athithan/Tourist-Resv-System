...
public static boolean adminLogin() {
    ...
    String password = scanner1.nextLine();
    System.out.println("________________________________");
    String filepath = "C:\\Adminlogin.csv";
    boolean found = false;
    boolean state =verifyAdminLogin(userName, password, filepath);
    return state;
  
}

public static boolean verifyAdminLogin( String userName,String password, String filepath){
boolean found = false;
String tempUsername="";
String tempPassword="";
